...
class iNatLinks_Widget extends WP_Widget {
    ...
    echo ' <li><a href="'.site_url() .'/?'.http_build_query(array('page_id' => get_option('inat_post_id'), 'verb' => 'add/transect')).'">'.__('Add Transect','inat').'</a></li>';
    echo ' <li><a href="'.site_url() .'/?'.http_build_query(array('page_id' => get_option('inat_post_id'), 'verb' => 'transects')).'">'.__('Transects','inat').'</a></li>';
    echo ' <li><a href="'.site_url() .'/?'.http_build_query(array('page_id' => get_option('inat_post_id'), 'verb' => 'logout')).'">'.__('Logout','inat').'</a></li>';
    echo '</ul>';
